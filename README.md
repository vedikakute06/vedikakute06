<h1 align="center">Hi 👋, I'm Vedika Kute</h1>
...
- 📫 Reach me at **vedikakute06@gmail.com**
...
| Project | Tech Stack | Description | Link |
|---|---|---|---|
| **Quick.ai** – AI Productivity Platform | PostgreSQL, Express, React, Node.js (PERN) | Full-stack SaaS with 10+ REST APIs automating content/productivity tasks (article writing, image gen, background removal, resume review) via Google Gemini API. | [Repo](https://github.com/vedikakute06/QuickAI) |
...
- AI Engineer Core Track: LLM Engineering, RAG, QLoRA, Agents — Ed Donner, Udemy *(in progress)*
- Python for Computer Vision with OpenCV and Deep Learning — Udemy
- Natural Language Processing (NLP) Specialization — Udemy
- The Complete Data Science Bootcamp 2025 — Udemy
- Deloitte Australia Data Analytics Job Simulation — Forage
- Tata Data Visualization Job Simulation — Forage
- ACM Winter School 2024 — Algorithms for Big Data & ML, PICT
- Supervised Machine Learning: Regression and Classification — Stanford, Coursera
- C, C++ & Data Structures — Chedo Tech
